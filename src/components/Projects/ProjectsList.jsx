...
export const projectsList = [
  {
    ...
    technologies: `React, Redux, Sagas, Node.js, Express.js, PostgreSQL, Postico, 
                   Material-UI, Moment, SweetAlert, and Charts.js`,
  ...
  },
  {
    ...
    description: `An exercise in Object-Oriented Programming, taking Richard
                  Pattis's Karel Robot concept and recreating it in Java. Like Pattis's 
                  Karel, these robots have beepers, move around the world and must 
